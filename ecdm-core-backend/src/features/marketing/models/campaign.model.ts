...
export { CampaignPlatform, CampaignStatus } from './campaign.types';
...
const campaignSchema = new Schema<ICampaignDocument>(
    {
        ...
        platform: { type: String, enum: Object.values(CampaignPlatform), required: [true, 'Platform is required'] },
        status:   { type: String, enum: Object.values(CampaignStatus),   default: CampaignStatus.Future },
...
const Campaign: Model<ICampaignDocument> = mongoose.model<ICampaignDocument>('Campaign', campaignSchema);
