...
export interface IWorkOrder {
    ...
    // Tracking
    invoiceId?:             string;     // Linked Invoice Number
    invoiceStatus?:         string;     // Invoice Status (Linked from Finance)
    
    // Commission Tracking (for Order Finance Match)
    engineerId?:            Types.ObjectId;  // Ref to User
    commissionPercentage?:  number;          // Percentage of the total parts/job
