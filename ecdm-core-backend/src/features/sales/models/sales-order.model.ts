...
import { ISalesOrderDocument, QuotationStatus, SalesOrderFinalStatus, OrderStatus } from '../types/sales-order.types';
...
const salesOrderSchema = new Schema<ISalesOrderDocument>(
    {
        ...
        statusSecondFollowUp:              { type: String, enum: Object.values(QuotationStatus) },
        
        // Third Follow-Up
        followUpThird:                     { type: Date },
        finalStatusThirdFollowUp:          { type: String, enum: Object.values(SalesOrderFinalStatus) },
