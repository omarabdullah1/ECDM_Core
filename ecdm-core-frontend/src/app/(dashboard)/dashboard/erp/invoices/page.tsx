...
const ST_C: Record<string, string> = { Draft: 'bg-[hsl(var(--muted))]/50 text-[hsl(var(--muted-foreground))]', Sent: 'bg-blue-500/15 text-blue-400', Paid: 'bg-emerald-500/15 text-emerald-400', Overdue: 'bg-red-500/15 text-red-400', Cancelled: 'bg-amber-500/15 text-amber-400' };
