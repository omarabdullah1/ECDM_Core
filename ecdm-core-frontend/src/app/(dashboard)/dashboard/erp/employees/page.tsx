...
const DEPT_C: Record<string, string> = { Engineering: 'bg-blue-500/15 text-blue-400', Sales: 'bg-purple-500/15 text-purple-400', Marketing: 'bg-pink-500/15 text-pink-400', HR: 'bg-amber-500/15 text-amber-400', Finance: 'bg-emerald-500/15 text-emerald-400', Operations: 'bg-indigo-500/15 text-indigo-400', Other: 'bg-[hsl(var(--muted))]/50 text-[hsl(var(--muted-foreground))]' };
